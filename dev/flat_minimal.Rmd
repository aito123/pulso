...
library(testthat)
#data <- system.file("data_prueba", package = "pulso")
...
barra_apilada_n<-function(data, ..., ordenado=TRUE){
  ...
  labels <- tibble(
    pregunta = sort(rep(as.character(unlist(sjlabelled::get_label(data[, 
...
fusen::inflate(flat_file = "dev/flat_minimal.Rmd", vignette_name = "Introducción")
```
